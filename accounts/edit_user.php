...
$first_name = $middle_initial = $last_name = $designation = $laboratory = $username = $password = $confirm_password = "";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($username_error) && empty($password_error) && empty($confirm_password_error)) {
        ...
        $stmt = $conn->prepare("UPDATE users SET first_name = ?, middle_initial = ?, last_name = ?, designation = ?, laboratory = ?, username = ?, `password` = ? WHERE id = ?");
        $stmt->bind_param("sssssssi", $first_name, $middle_initial, $last_name, $designation, $laboratory, $username, $hashed_password, $user_id);
            ...
            <div class="information">
                ...
                <form action="edit_user.php?id=<?php echo $user_id; ?>" method="POST">
                    ...
                    <div class="input-group" id="password_group">
                        ...
                        <input type="password" class="name-input" name="password" placeholder="Password">
                    ...
                    <div class="input-group" id="matching_group">
                        ...
                        <input type="password" class="name-input" name="confirm_password" placeholder="Re-enter Password">
