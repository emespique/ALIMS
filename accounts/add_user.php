...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($username_error) && empty($password_error) && empty($confirm_password_error)) {
        ...
        $stmt = $conn->prepare("INSERT INTO users (first_name, middle_initial, last_name, designation, laboratory, username, password) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("sssssss", $first_name, $middle_initial, $last_name, $designation, $laboratory, $username, $hashed_password);
